...
// --- AdminOrders list ---
const AdminOrders = ({ title, params }) => {
    ...
    const buildUrl = () => {
        let url = `/orders/adminorders/${params.store_id}?limit=10`;
    ...
    const fetchInitialOrders = async () => {
        ...
        try {
            ...
            const url = `/orders/adminorders/${params.store_id}?limit=10`;
        ...
        <FlatList
            ...
            ListHeaderComponent={() => (
                <View className="flex-row px-2 justify-between items-center my-6">
                    <Text className="mt-1 text-2xl" style={{ fontFamily: 'ubuntu-medium' }}>
                        {title}
                    </Text>
                    <View
