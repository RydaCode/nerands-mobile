...
const FashionCosmeticsProducts = ({params}) => {
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View className='w-full flex-row justify-satrt items-center'>
                    ...
                    <View className='w-[75%] ml-1'>
                        ...
                        <Text className='text-md text-slate' style={{fontFamily: 'maven-medium'}}>Fashion & Cosmetics</Text>
                    </View>
                </View>
                <View className='w-full mt-10'>
                    ...
                    <FormInputs
                        ...
                        desc='Please enter product colors (Eg: Red, blue, Green, Navy Blue, etc)'
                        borderStyle='border border-lavender'
                    />
                    <FormInputs
                        title='Product Sizes'
                        handleChangeText={(value) => handleChangeText('sizes', value)}
                        desc='Please enter product (Eg: S, M, L, Xl or 32, 33, 34 etc). The format will be based on the sizing type of your product.'
                        borderStyle='border border-lavender'
                    />
                    <DescriptionInput
                        title='Description'
                        handleChangeText={(value) => handleChangeText('product_description', value)}
                        desc='Please add descrpition to the product. Ensure to put a description that best describe your product.'
                        otherStyles='text-lg'
...
export default FashionCosmeticsProducts